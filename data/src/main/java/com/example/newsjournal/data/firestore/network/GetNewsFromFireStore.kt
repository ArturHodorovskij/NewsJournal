...
class GetNewsFromFireStore: NewsFireStore {
    override suspend fun getNewsFromFireStore(collection:String): TopStoriesFireStore?{
        val getNews = FireStoreApiClient.api.getNews(PROJECT_ID, collection,DOCUMENT_ID )
        return getNews
    }
}